...
public class CarGameAdditionValidatorTest {
    ...
    public void shouldValidateCarAdditionForGivenGame(){
        ...
        when(mapService.isFieldReachableOnGameMap(gameMapContent, startingPoint)).thenReturn(true);
        ...
        verify(mapService).isFieldReachableOnGameMap(eq(gameMapContent), eq(startingPoint));
    }
